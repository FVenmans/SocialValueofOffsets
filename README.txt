...
The value of the offset is shown in sheet 2, cell N8 and expressed as a proportion of the SCC (cell O8). 
...
Sheet 3 shows the value of the project if the exact impact response function of Joos/Geoffroy is used rather than an stepfunction.
